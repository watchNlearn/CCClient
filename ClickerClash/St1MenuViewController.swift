    ...
    override func viewDidLoad() {
        ...
        ref.child("tournaments").child("silver").child("st1").child("usersPlaying").observeSingleEvent(of: .value, with: {(snapshot) in
            if snapshot.hasChild(self.username!) {
                ref.child("tournaments").child("silver").child("st1").child("usersPlaying").child(self.username).observeSingleEvent(of: .value, with: {(snapshot) in
        ...
        ref.child("tournaments").child("silver").child("st1").child("usersPlaying").queryOrderedByValue().queryLimited(toLast: 10).observeSingleEvent(of: .value, with: { (snapshot) in
            ...
            if self.hs6.text != "" {
                ...
                ref.child("tournaments").child("silver").child("st1").child("usersPlaying").child(hs6Username!).observeSingleEvent(of: .value, with: { (snapshot) in
                    let value = snapshot.value as! Int
            ...
            if self.hs7.text != "" {
                ...
                ref.child("tournaments").child("silver").child("st1").child("usersPlaying").child(hs7Username!).observeSingleEvent(of: .value, with: { (snapshot) in
                    let value = snapshot.value as! Int
            ...
            if self.hs8.text != "" {
                ...
                ref.child("tournaments").child("silver").child("st1").child("usersPlaying").child(hs8Username!).observeSingleEvent(of: .value, with: { (snapshot) in
                    let value = snapshot.value as! Int
            ...
            if self.hs9.text != "" {
                ...
                ref.child("tournaments").child("silver").child("st1").child("usersPlaying").child(hs9Username!).observeSingleEvent(of: .value, with: { (snapshot) in
                    let value = snapshot.value as! Int
            ...
            if self.hs10.text != "" {
                ...
                ref.child("tournaments").child("silver").child("st1").child("usersPlaying").child(hs10Username!).observeSingleEvent(of: .value, with: { (snapshot) in
                    let value = snapshot.value as! Int
        ...
        ref.child("tournaments").child("silver").child("st1").child("users").observe(.value, with: {(snapshot) in
